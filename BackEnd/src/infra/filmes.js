...
// VALUES
// (1, 'Pai Rico, Pai Pobre', 336),
// (2, 'Pedagogia do Oprimido', 256),
// (3, 'Investimentos inteligentes', 256),
// (4, '20 regras de ouro para educar filhos e alunos', 208),
// (5, 'Pais brilhantes, professores fascinantes', 176),
// (6, 'É assim que acaba', 368),
// (7, 'A revolução dos bichos', 152),
// (8, 'O Diário Perdido de Gravity Falls', 288),
// (9, 'A garota do lago', 296),
// (10, 'Guardiola confidencial', 416)
// `
